...
public class Constants {
    ...
    public static final String ACTION_PLAY_PAUSE = "com.boom.music.player.action.PLAY_PAUSE";
    public static final String ACTION_STOP = "com.boom.music.player.action.STOP";
    public static final String ACTION_NEXT = "com.boom.music.player.action.NEXT";
    public static final String ACTION_PREVIOUS = "com.boom.music.player.action.PREVIOUS";
    public static final String ACTION_PAUSE = "com.boom.music.player.action.PAUSE";

    public static final String ACTION_UPDATE_NOW_PLAYING_UI = "com.boom.music.player.action.UPDATE_NOW_PLAYING_UI";
